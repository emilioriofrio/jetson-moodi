...
TARGET_W, TARGET_H = 640, 480 #1280, 720      # tamaño de ventana
...
def render_mod_A(pa, show_details=False):
    # label de A = nivel de estrés facial 
...
# Posiciona el panel alrededor de la cara
...
def run_viewer(cfg_path: str, frames_q, preds_q, reporter_q, stop_event: Event):
    ...
    last_face_region = None  # (x,y,w,h) 

    # Payload del reporter 
    last_global = {
        "label": "INSEGURO",
        "avg_level": None,
        "n_valid": 0,
